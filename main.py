...
def main():
    ...
    print()
    print("AI Agents:")
    print("  - Guided: Stage-based with memory (best for Pokemon)")
    print("  - Ollama: Basic vision agent")
    print("  - Random: Random buttons (testing)")
    print()
    print("Requires Ollama with vision model:")
    print("  ollama pull llava && ollama serve")
    print()
    print("=" * 60)
