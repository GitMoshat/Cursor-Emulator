...
def main():
    ...
    print("  ESC         - Quit")
    print()
    print("AI Agent Controls:")
    print("  F2          - Toggle AI Agent On/Off")
    print("  F3          - Cycle AI Agent Type")
    print("  F4          - Manually Advance Stage")
    print()
    print("AI Agents:")
    print("  - Memory:  Direct memory reading (DEFAULT, fastest, no LLM needed)")
    print("  - Guided:  Vision + stages (needs Ollama + llava)")
    print("  - Ollama:  Basic vision (needs Ollama + llava)")
    print("  - Random:  Random buttons (testing)")
    print()
    print("Memory Agent reads game state directly from RAM:")
    print("  - Player position, facing direction, map")
    print("  - Party Pokemon, HP, levels")
    print("  - Battle state, enemy info")
    print("  - Menu/dialog state")
    print()
    print("=" * 60)
